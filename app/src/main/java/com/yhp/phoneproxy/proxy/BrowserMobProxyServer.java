package com.yhp.phoneproxy.proxy;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import com.google.common.collect.MapMaker;
import com.yhp.phoneproxy.mitm.Authority;
import com.yhp.phoneproxy.mitm.CertificateSniffingMitmManager;
import com.yhp.phoneproxy.proxy.client.ClientUtil;
import com.yhp.phoneproxy.proxy.core.har.Har;
import com.yhp.phoneproxy.proxy.core.har.HarLog;
import com.yhp.phoneproxy.proxy.core.har.HarNameVersion;
import com.yhp.phoneproxy.proxy.core.har.HarPage;
import com.yhp.phoneproxy.proxy.core.har.PageRefFilteredHar;
import com.yhp.phoneproxy.proxy.filters.AddHeadersFilter;
import com.yhp.phoneproxy.proxy.filters.AutoBasicAuthFilter;
import com.yhp.phoneproxy.proxy.filters.BlacklistFilter;
import com.yhp.phoneproxy.proxy.filters.BrowserMobHttpFilterChain;
import com.yhp.phoneproxy.proxy.filters.HarCaptureFilter;
import com.yhp.phoneproxy.proxy.filters.HttpConnectHarCaptureFilter;
import com.yhp.phoneproxy.proxy.filters.HttpsHostCaptureFilter;
import com.yhp.phoneproxy.proxy.filters.HttpsOriginalHostCaptureFilter;
import com.yhp.phoneproxy.proxy.filters.LatencyFilter;
import com.yhp.phoneproxy.proxy.filters.RegisterRequestFilter;
import com.yhp.phoneproxy.proxy.filters.RequestFilter;
import com.yhp.phoneproxy.proxy.filters.RequestFilterAdapter;
import com.yhp.phoneproxy.proxy.filters.ResolvedHostnameCacheFilter;
import com.yhp.phoneproxy.proxy.filters.ResponseFilter;
import com.yhp.phoneproxy.proxy.filters.ResponseFilterAdapter;
import com.yhp.phoneproxy.proxy.filters.RewriteUrlFilter;
import com.yhp.phoneproxy.proxy.filters.UnregisterRequestFilter;
import com.yhp.phoneproxy.proxy.filters.WhitelistFilter;
import com.yhp.phoneproxy.proxy.mitm.TrustSource;
import com.yhp.phoneproxy.proxy.proxy.ActivityMonitor;
import com.yhp.phoneproxy.proxy.proxy.BlacklistEntry;
import com.yhp.phoneproxy.proxy.proxy.CaptureType;
import com.yhp.phoneproxy.proxy.proxy.RewriteRule;
import com.yhp.phoneproxy.proxy.proxy.Whitelist;
import com.yhp.phoneproxy.proxy.proxy.auth.AuthType;
import com.yhp.phoneproxy.proxy.proxy.dns.AdvancedHostResolver;
import com.yhp.phoneproxy.proxy.proxy.dns.ChainedHostResolver;
import com.yhp.phoneproxy.proxy.proxy.dns.DelegatingHostResolver;
import com.yhp.phoneproxy.proxy.util.BrowserMobHttpUtil;
import com.yhp.phoneproxy.proxy.util.BrowserMobProxyUtil;
...
public class BrowserMobProxyServer implements BrowserMobProxy {
     ...
     * or {@link ClientUtil#createDnsJavaResolver()}. You can also build your own resolver, or use {@link ChainedHostResolver}
...
//            bootstrap.withManInTheMiddle(mitmManager);
     ...
     * to disable aggregation (which disallows access to the {@link HttpMessageContents}), you may add the filter source
